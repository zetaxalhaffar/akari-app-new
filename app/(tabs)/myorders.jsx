              ...
              ListEmptyComponent={() =>
                sharesOrdersLoading || apartmentsOrdersLoading ? (
                  ...
                  <EmptyScreen
                    ...
                    title={
                      tabId === 'shares'
                        ? `لترتيب موعد مع مالك الأسهم، افتح صفحة السهم واضغط على الزر الخاص بالتواصل مع فريق عقاري ومن ثم إختر "ترتيب موعد" ، سوف يقوم فريق عقاري بالتواصل معك لترتيب موعد مع مالك الأسهم.
و سوف تظهر جميع مواعيدك هنا بمجرد طلبها.`
                        : `لترتيب موعد مع مالك العقار، افتح صفحة العقار واضغط على الزر الخاص بالتواصل مع فريق عقاري ومن ثم إختر "ترتيب موعد" ، سوف يقوم فريق عقاري بالتواصل معك لترتيب موعد مع مالك العقار.
و سوف تظهر جميع مواعيدك هنا بمجرد طلبها.`
                    }
                  />
                )
