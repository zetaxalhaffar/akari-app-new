...
const CustomHeadWithBackButton = ({ title, rightText, rightTextPress, handleButtonPress, rightIcon, rightIconPress }) => {
  return (
    <View
      ...
      {rightText && (
        <View>
          <Text
            ...
            className="text-right font-psemibold text-base underline">
            {rightText}
          </Text>
        </View>
      )}
